...
使用[图8.4](chapter008.xhtml#Fig_8-4)作为模型，说明在数组*A* = 〈.79, .13, .16, .64, .39, .20, .89, .53, .71, .42〉上的BUCKET-SORT操作。
...
***b.*** 使用决策树和您在(a)部分的答案，证明任何正确合并两个排序列表的算法必须执行至少2*n* – *o*(*n*)次比较。
