...
如果上三角矩阵沿对角线具有全部为1的元素，则称为***单位上三角矩阵***。
...
如果一个矩阵有逆，那么它被称为***可逆***或***非奇异***。矩阵的逆，如果存在，是唯一的。（参见练习D.2-1。）如果*A*和*B*是非奇异的*n* × *n*矩阵，则
...
证明定理D.2。即，证明矩阵*A*具有完整列秩当且仅当*Ax* = 0意味着*x* = 0。(*提示:* 将一列对其他列的线性相关性表达为矩阵-向量方程。)
