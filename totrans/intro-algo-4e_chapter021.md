...
GENERIC-MST中第2-4行的**while**循环执行|*V*| - 1次，因为它在每次迭代中找到一个最小生成树的|*V*| - 1条边。最初，当*A* = Ø时，在*G[A]*中有|*V*|棵树，每次迭代将该数字减少1。当森林只包含一棵树时，方法终止。
