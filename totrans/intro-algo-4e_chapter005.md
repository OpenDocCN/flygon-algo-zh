...
+   *直到每个箱子至少包含一个球需要投掷多少球？* 让我们称一个球掉入空箱子的投掷为“命中”。我们想知道获得*b*个命中所需的预期次数*n*。
    ...
    让*n[i]*表示第*i*阶段所需的投掷次数。获得*b*个命中所需的投掷次数为![art](images/Art_P269.jpg)。每个随机变量*n[i]*都具有成功概率(*b* – *i* + 1)/*b*的几何分布，因此，根据方程(C.36)，我们有
